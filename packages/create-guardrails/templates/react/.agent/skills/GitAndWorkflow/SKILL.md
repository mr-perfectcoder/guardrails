---
name: gitandworkflow
description: Guidelines and best practices for Git Workflow & Commit Standards in react.
---
...
```
// Bad: won't link to the Jira issue
feat(auth): add login form validation
```
...
2.  **If YES**: Always request the issue key (`e.g., PROJ-123`) before building any commit message.
